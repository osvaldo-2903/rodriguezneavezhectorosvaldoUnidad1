        ...
        <div class="container">
            ...
            <section id="buzon" class="buzon">
              ...
              <form id="buzon1" action="../public_html/assets/php/guardar_comentario.php" method="post">
                <div class="mb-3">
                  <label for="exampleInputEmail1" id="caja" class="form-label">Caja de comentarios</label><input name="nombre" type="text">nombre
                  <input type="text" class="form-control" id="exampleInputEmail1" name="coment" aria-describedby="emailHelp">
            ...
            <footer class="footer mt-5 border-top">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6 text-center text-md-left">
                        <p class="mb-0">Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a target="_blank" href="http://www.devcrud.com">Venmus</a></p>
                    </div>
